...
const school_colors = {
    "Notre Dame": "rgba(12, 35, 64, 0.9)",
    "Baylor": "rgba(0, 48, 37, 0.9)",
    "Iowa State": "rgba(130, 36, 51, 0.9)",
    "Kansas": "rgba(0, 81, 186, 0.9)",
    "Kansas State": "rgba(81, 40, 144, 0.9)",
    "Oklahoma": "rgba(132, 22, 23, 0.9)",
    "Oklahoma State": "rgba(255, 124, 25, 0.9)",
    "Texas": "rgba(191, 87, 0, 0.9)",
    "TCU": "rgba(77, 25, 121, 0.9)",
    "Texas Tech": "rgba(204, 0, 0, 0.9)",
    "West Virginia": "rgba(0, 40, 85, 0.9)",
    "Illinois": "rgba(19, 41, 75, 0.9)",
    "Indiana": "rgba(153, 0, 0, 0.9)",
    "Iowa": "rgba(255, 205, 0, 0.9)",
    "Maryland": "rgba(224, 25, 34, 0.9)",
    "Michigan": "rgba(0, 39, 76, 0.9)",
    "Michigan State": "rgba(24, 69, 59, 0.9)",
    "Minnesota": "rgba(122, 0, 25, 0.9)",
    "Nebraska": "rgba(228, 17, 43, 0.9)",
    "Northwestern": "rgba(78, 42, 132, 0.9)",
    "Ohio State": "rgba(187, 0, 0, 0.9)",
    "Penn State": "rgba(4, 30, 66, 0.9)",
    "Purdue": "rgba(206, 184, 136, 0.9)",
    "Rutgers": "rgba(204, 0, 51, 0.9)",
    "Wisconsin": "rgba(197, 5, 12, 0.9)",
    "Arizona": "rgba(12, 35, 64, 0.9)",
    "Arizona State": "rgba(142, 35, 52, 0.9)",
    "California": "rgba(0, 50, 91, 0.9)",
    "Colorado": "rgba(207, 184, 110, 0.9)",
    "Oregon": "rgba(18, 71, 52, 0.9)",
    "Oregon State": "rgba(220, 68, 5, 0.9)",
    "Stanford": "rgba(140, 21, 21, 0.9)",
    "UCLA": "rgba(45, 104, 196, 0.9)",
    "USC": "rgba(153, 0, 0, 0.9)",
    "Utah": "rgba(204, 0, 0, 0.9)",
    "Washington": "rgba(51, 0, 111, 0.9)",
    "Washington State": "rgba(152, 30, 50, 0.9)",
    "Alabama": "rgba(158, 27, 50, 0.9)",
    "Arkansas": "rgba(157, 34, 53, 0.9)",
    "Auburn": "rgba(12, 35, 64, 0.9)",
    "Florida": "rgba(0, 33, 165, 0.9)",
    "Georgia": "rgba(186, 12, 47, 0.9)",
    "Kentucky": "rgba(0, 51, 160, 0.9)",
    "LSU": "rgba(70, 29, 124, 0.9)",
    "Mississippi": "rgba(206, 17, 38, 0.9)",
    "Mississippi State": "rgba(102, 0, 0, 0.9)",
    "Missouri": "rgba(0, 0, 0, 0.9)",
    "South Carolina": "rgba(115, 0, 10, 0.9)",
    "Tennessee": "rgba(255, 130, 0, 0.9)",
    "Texas A&M": "rgba(80, 0, 0, 0.9)",
    "Vanderbilt": "rgba(134, 109, 75, 0.9)",
    "Boston College": "rgba(152, 30, 50, 0.9)",
    "Clemson": "rgba(245, 102, 0, 0.9)",
    "Duke": "rgba(0, 48, 135, 0.9)",
    "Florida State": "rgba(120, 47, 64, 0.9)",
    "Georgia Tech": "rgba(179, 163, 105, 0.9)",
    "Louisville": "rgba(173, 27, 46, 0.9)",
    "Miami": "rgba(244, 115, 33, 0.9)",
    "North Carolina": "rgba(123, 175, 212, 0.9)",
    "North Carolina State": "rgba(204, 0, 0, 0.9)",
    "Pitt": "rgba(0, 53, 148, 0.9)",
    "Syracuse": "rgba(247, 105, 0, 0.9)",
    "Virginia": "rgba(35, 45, 75, 0.9)",
    "Virginia Tech": "rgba(99, 0, 49, 0.9)",
    "Wake Forest": "rgba(158, 126, 56, 0.9)"
};
